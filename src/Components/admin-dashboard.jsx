            ...
            <main className='flex flex-col col-span-4 gap-8 w-full'>
                            ...
                            <div>
                             <div className="flex min-h-[180px] flex-1 flex-col gap-8 py-4">
                                ...
                                <div className="flex justify-around">
                                    <p className="text-[#90adcb] text-[13px] font-bold leading-normal tracking-[0.015em]">Jan</p>
                                    <p className="text-[#90adcb] text-[13px] font-bold leading-normal tracking-[0.015em]">Feb</p>
                                    <p className="text-[#90adcb] text-[13px] font-bold leading-normal tracking-[0.015em]">Mar</p>
                                    <p className="text-[#90adcb] text-[13px] font-bold leading-normal tracking-[0.015em]">Apr</p>
                                    <p className="text-[#90adcb] text-[13px] font-bold leading-normal tracking-[0.015em]">May</p>
                                    <p className="text-[#90adcb] text-[13px] font-bold leading-normal tracking-[0.015em]">Jun</p>
                                    <p className="text-[#90adcb] text-[13px] font-bold leading-normal tracking-[0.015em]">Jul</p>
                                    <p className="text-[#90adcb] text-[13px] font-bold leading-normal tracking-[0.015em]">Aug</p>
                                    <p className="text-[#90adcb] text-[13px] font-bold leading-normal tracking-[0.015em]">Sep</p>
                                    <p className="text-[#90adcb] text-[13px] font-bold leading-normal tracking-[0.015em]">Oct</p>
                                    <p className="text-[#90adcb] text-[13px] font-bold leading-normal tracking-[0.015em]">Nov</p>
                                    <p className="text-[#90adcb] text-[13px] font-bold leading-normal tracking-[0.015em]">Dec</p>
                                </div>
                             </div>
                            </div>
                        </div>
                ...
                <div className="flex min-h-[180px] flex-1 flex-col gap-8 py-4">
                  <svg width="100%" height="148" viewBox="-3 0 478 150" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
                    ...
                    <defs>
                      <linearGradient id="paint0_linear_1131_5935" x1="236" y1="1" x2="236" y2="149" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#233648"></stop>
                        <stop offset="1" stop-color="#233648" stop-opacity="0"></stop>
                      </linearGradient>
                    </defs>
                  </svg>
                  <div class="flex justify-around">
                    <p class="text-[#92aec9] text-[13px] font-bold leading-normal tracking-[0.015em]">Jan</p>
                    <p class="text-[#92aec9] text-[13px] font-bold leading-normal tracking-[0.015em]">Feb</p>
                    <p class="text-[#92aec9] text-[13px] font-bold leading-normal tracking-[0.015em]">Mar</p>
                    <p class="text-[#92aec9] text-[13px] font-bold leading-normal tracking-[0.015em]">Apr</p>
                    <p class="text-[#92aec9] text-[13px] font-bold leading-normal tracking-[0.015em]">May</p>
                  </div>
                </div>
                  ...
                  <div className="border-[#92aec9] bg-[#233648] border-t-2 w-full" style="height: 40%;"></div>
